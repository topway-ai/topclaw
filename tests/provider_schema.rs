...
use topclaw::providers::compatible::AuthStyle;
use topclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use topclaw::providers::compatible::OpenAiCompatibleProvider;
