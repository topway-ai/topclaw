...
- **Κοινό**: Διαχειριστές συστημάτων και συντηρητές που λειτουργούν το TopClaw σε εταιρικά ή περιορισμένα δίκτυα.
...
### 1.1 Proxy μόνο για το TopClaw (Internal Traffic)

- **Περιγραφή**: Διαμεσολάβηση μόνο για την εσωτερική κίνηση του δαίμονα.
- **Εμβέλεια (Scope)**: `topclaw`.
...
|:---|:---|:---:|:---|
| `topclaw` | Εσωτερικοί HTTP clients | Όχι | Αποφυγή παρενεργειών στο σύστημα. |
...
### Λειτουργία Α: Εσωτερική Διαμεσολάβηση (TopClaw only)
