...
**Date:** 2026-02-24
**Tester:** TopClaw Agent (automated testing)
...
Qwen OAuth integration has been successfully validated and configured for TopClaw. The provider is **ready for production use** with the following characteristics:
...
## 4. TopClaw Integration Testing

### 4.1 Configuration

**File:** `/home/spex/.topclaw/config.toml`
...
**Usage:**
```bash
cd /home/spex/work/erp/topclaws
