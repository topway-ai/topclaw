...
# For 64-bit (aarch64):
curl -LO https://github.com/topclaw-labs/topclaw/releases/latest/download/topclaw-aarch64-linux-android.tar.gz
tar xzf topclaw-aarch64-linux-android.tar.gz

# For 32-bit (armv7):
curl -LO https://github.com/topclaw-labs/topclaw/releases/latest/download/topclaw-armv7-linux-androideabi.tar.gz
