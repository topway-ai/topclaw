...
## Problem
TopClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/topclaw/audit.key"
...
topclaw audit --user @alice

# Show all high-risk commands
topclaw audit --risk high

# Show violations from last 24 hours
topclaw audit --since 24h --violations-only

# Export to JSON for analysis
topclaw audit --format json --output audit.json
