# Adding Boards and Tools — TopClaw Hardware Guide

This guide explains how to add new hardware boards and custom tools to TopClaw.
...
With the `rag-pdf` feature, TopClaw can index PDF files:
