...
- **版本**: v2.0.1
- **描述**: 集成18个搜索引擎（8国内+10国际），支持高级搜索语法
- **发布时间**: 2026-02-06

## 搜索引擎

**国内（8个）**: 百度、必应、360、搜狗、微信、头条、集思录
**国际（10个）**: Google、DuckDuckGo、Yahoo、Brave、Startpage、Ecosia、Qwant、Yandex、WolframAlpha
...
// Yandex区域搜索
web_fetch({"url": "https://yandex.com/search/?text=rust+ecosystem"})
