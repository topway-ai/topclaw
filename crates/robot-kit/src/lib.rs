//! # TopClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with TopClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  TopClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use topclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of TopClaw. It defines its own
//! `Tool` trait that is compatible with TopClaw's but doesn't require it.
//!
//! ## Safety
//!
