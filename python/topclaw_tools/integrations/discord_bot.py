"""
Discord bot integration for TopClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by TopClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install topclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"TopClaw Discord Bot ready: {self.client.user}")
