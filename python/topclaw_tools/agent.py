...
SYSTEM_PROMPT = """You are TopClaw, an AI assistant with tool access. Use tools to accomplish tasks.
...
def create_agent(
    ...
    """
    Create a TopClaw agent with LangGraph-based tool calling.
    ...
    Example:
        ```python
        from topclaw_tools import create_agent, shell, file_read
