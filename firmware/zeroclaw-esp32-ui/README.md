# TopClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for TopClaw edge scenarios on ESP32.
...
3. Connect UI state with TopClaw edge/runtime messaging
...
- [TopClaw Hardware Design](../../docs/hardware-peripherals-design.md)
