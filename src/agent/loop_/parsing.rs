...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/topclaw/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to TopClaw tool names.
...
/// to. This function encodes the mapping for known TopClaw tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. TopClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
