...
const SNAPSHOT_HEADER: &str = "# 🧠 TopClaw Memory Snapshot\n\n\
    > Auto-generated by TopClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 TopClaw Memory Snapshot

> Auto-generated by TopClaw.
...
I am TopClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 TopClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
