...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(topclaw_dir);
...
pub fn secret_file_path(topclaw_dir: &Path) -> PathBuf {
    topclaw_dir.join(OTP_SECRET_FILE)
}
