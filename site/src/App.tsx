...
const repoBase = "https://github.com/topclaw-labs/topclaw/blob/main";
const rawBase = "https://raw.githubusercontent.com/topclaw-labs/topclaw/main";
      ...
      <header className="topbar">
        <div className="topbar-inner">
          ...
          <nav className="top-nav" aria-label="Primary">
            ...
            <a href="https://github.com/topclaw-labs/topclaw" target="_blank" rel="noreferrer">
              {text.navGitHub}
            </a>
