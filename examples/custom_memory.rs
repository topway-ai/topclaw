//! Example: Implementing a custom Memory backend for TopClaw
//!
...
// ── Re-define the trait types (in your app, import from topclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 TopClaw Memory Demo — InMemoryBackend\n");
