...
run_step "cargo check --features computer-use-sidecar" cargo check --features computer-use-sidecar
run_step "cargo check --features full" cargo check --features full
run_step "cargo test" cargo test
run_step "cargo test --features computer-use-sidecar" cargo test --features computer-use-sidecar
