...
REQUIRED_REFERENCES = {
    ...
    "sbom_cyclonedx": "topclaw.cdx.json",
    "sbom_spdx": "topclaw.spdx.json",
    "checksums_provenance": "topclaw.sha256sums.intoto.json",
...
def main() -> int:
    ...
    report: dict[str, object] = {
        "schema_version": "topclaw.release-notes-supply-chain.v1",
